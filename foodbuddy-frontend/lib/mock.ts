...
export const MOCK_RESTAURANTS: RestaurantDetail[] = [
  ...
  },
  {
    ...
    deals: [
      { id: "d2", title: "10% Off Lunch", description: "Weekdays only", validFrom: "Oct 12", validTo: "Oct 31" }
    ],
    menus: [
      {
        id: "m2",
  ...
  },
  {
    ...
    tags: ["healthy", "vegan-friendly"],
    deals: [
      { id: "d3", title: "10% Off Lunch", description: "Weekdays only", validFrom: "Oct 12", validTo: "Oct 31" }
    ],
    menus: [
      {
        id: "m3",
  ...
  },
  {
    ...
    deals: [
      { id: "d6", title: "Taco Tuesday 2-for-1", description: "Select tacos only" }
    ],
    menus: [
      {
        id: "m6",
  ...
  },
  {
    ...
    deals: [
      { id: "d7", title: "BOGO Coffee", description: "Buy one, get one free" }
    ],
    menus: [
      {
        id: "m7",
